...
(setf *Mejora2* 
  (make-jugador
   :nombre 'Mejora2
   :f-juego #'f-j-nmx
   :f-eval #'mi-f-ev-Mejora2))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(defun mi-f-ev-Mejora (estado )
   ;mis fichas menos las del contrario
  (let* ((tablero (estado-tablero estado)) 
         (p0 (estado-lado-sgte-jugador estado))
         (p1 (lado-contrario (estado-lado-sgte-jugador estado)))
    ...
    (+ (*(- 19 kahala-p1) 0.75)
       ...
       ;restamos la distancia de cada hoyo a nuestro kahala. Las fichas que pasen ese numero
       ;iran al lado contrario y las perderemos. Ponderamos cada hoyo
       (*(- 1 fichas-p0-5) 5)
       (* (- 1 fichas-p1-5) -5)
...
(setf *Mejora* 
  (make-jugador
   :nombre 'Mejora
   :f-juego #'f-j-nmx
   :f-eval #'mi-f-ev-Mejora))


;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;


(defun mi-f-ev-SevMALO (estado)
  (let* ((tablero (estado-tablero estado)) 
         (p0 (estado-lado-sgte-jugador estado))
         (p1 (lado-contrario (estado-lado-sgte-jugador estado)))
         (fichas-p1-0 (get-fichas tablero p1 0)) (fichas-p0-0 (get-fichas tablero p0 0))
...
(partida 0 5 (list *AlACT* *Mejora*))
(partida 0 5 (list *Mejora* *AlACT*))

(partida 0 3 (list *SevACT* *Mejora*))
(partida 0 3 (list *Mejora* *SevACT*))


(partida 0 3 (list *Mejora* *SiACT*))
(partida 0 3 (list *SiACT* *Mejora*))

(partida 0 3 (list *OLDSeverus* *Mejora*))
(partida 0 3 (list *Mejora* *OLDSeverus*))

(partida 0 2 (list *SiACT* *AlACT*))
(partida 0 2 (list *AlACT* *SiACT*))

(partida 0 2 (list *Mejora* *jdr-humano*))
...
(setf *P1* 
  (make-jugador-gen
   :num 1
   :sum 0
   :pesos '(1.5 12 10 8 7 5 3 2 2 1 3 3 3 3 3 3)
   :jugador *AlACT*))
...
(make-jugador-gen
 :num 2
 :sum 0
 :pesos '(3 12 10 8 7 5 3 2 2 1 3 3 3 3 3 3)
 :jugador *SiACT*))
...
(make-jugador-gen
 :num 3
 :sum 0
 :pesos '(5 12 10 8 7 5 3 2 2 1 3 3 3 3 3 3)
 :jugador *SevACT*))
...
(make-jugador-gen
 :num 4
 :sum 0
 :pesos '(0 12 10 8 7 5 3 2 2 1 3 3 3 3 3 3)
 :jugador *kk1*))
...
(make-jugador-gen
 :num 5
 :sum 0
 :pesos '(1.5 12 10 8 7 5 3 2 2 1 5 5 5 5 5 5)
 :jugador *kk2*))
...
(make-jugador-gen
 :num 6
 :sum 0
 :pesos '(1.5 12 10 8 7 5 3 2 2 1 2 2 2 2 2 2)
 :jugador *kk3*))
...
(make-jugador-gen
 :num 7
 :sum 0
 :pesos '(1.5 12 10 8 7 5 3 2 2 1 7 6 2 1 4 8)
 :jugador *kk4*))
(setf *P8*
(make-jugador-gen
 :num 8
 :sum 0
 :pesos '(15 120 100 80 70 50 30 20 10 20 30 30 30 30 30 30)
 :jugador *kk5*))
(setf *P9*
(make-jugador-gen
 :num 9
 :sum 0
 :pesos '(0.15 1.20 1.00 0.80 0.70 0.50 0.30 0.20 0.10 0.20 .30 0.30 0.30 .30 0.30 .30)
 :jugador *kk6*))

(setf lplayers '(*P1* *P2* *P3* *P4* *P5* *P6* *P7* *P8* *P9*))


(mapcar #'(lambda(p1 p2) 
            (let ((res (partida 0 3 (list p1 p2))))
              (+ (jugador-gen-sum p1) 
