...
(defun mi-f-ev (estado) 
  ;caso en le que el jugador haya ganado
  ;;Obtenemos tolos valores que nos benefician de la partida le restamos loq ue nos perjudica
          (- (+(get-pts (estado-lado-sgte-jugador estado)) ;obtiene las fichas del jugador con el turno
             ...
             (*(get-fichas (estado-tablero estado) (estado-lado-sgte-jugador estado) 4) 0.4) ;<=fichasPos4*4
             (*(get-fichas (estado-tablero estado) (estado-lado-sgte-jugador estado) 5) 0.6) ;<=fichasPos5*6
             (*(get-fichas (estado-tablero estado) (lado-contrario (estado-lado-sgte-jugador estado)) 4) -0.4) ;<=fichasPosRival4*-2
             (*(get-fichas (estado-tablero estado) (lado-contrario (estado-lado-sgte-jugador estado)) 5) -0.6)
 ...
 ;obtiene las fichas del kalaha del jugador que no tiene el turno

(setf *mi-jugador-a-b* 
  (make-jugador
   :nombre 'Jugador-Negamax-a-b
   :f-juego #'f-j-nmx
   :f-eval #'mi-f-ev))
...
(partida 0 2 (list *mi-jugador-a-b* *jdr-nmx-bueno*))
