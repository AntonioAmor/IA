...
;;;
;;;  se ha a?adido los parametros a, b
;;;  IMP, hay q meter color (diferencia min max de la wikipedia)?????
;;;
...
(defun mi-f-ev-Prueba (estado)
  ...
  (let ((tablero (estado-tablero estado)) (p0 (estado-lado-sgte-jugador estado))
    ...
    (+
     ...
     ;miramos los 0s en las psiciones enfrentadas
    ; (* (- (if (= 0 (get-fichas tablero p0 0)) 1 0) (if (= 0 (get-fichas tablero p1 5)) 1 0)) 1.3)
    ; (* (- (if (= 0 (get-fichas tablero p0 1)) 1 0) (if (= 0 (get-fichas tablero p1 4)) 1 0)) 1.3)
    ; (* (- (if (= 0 (get-fichas tablero p0 2)) 1 0) (if (= 0 (get-fichas tablero p1 3)) 1 0)) 1.5)
    ; (* (- (if (= 0 (get-fichas tablero p0 3)) 1 0) (if (= 0 (get-fichas tablero p1 2)) 1 0)) 1.5)
    ; (* (- (if (= 0 (get-fichas tablero p0 4)) 1 0) (if (= 0 (get-fichas tablero p1 1)) 1 0)) 1.3)
    ; (* (- (if (= 0 (get-fichas tablero p0 5)) 1 0) (if (= 0 (get-fichas tablero p1 0)) 1 0)) 1.3)))) 
     
     (* (- (if (= 0 (get-fichas tablero p1 0)) 1 0) (if (= 0 (get-fichas tablero p0 5)) 1 0)) 0.3)
     (* (- (if (= 0 (get-fichas tablero p1 1)) 1 0) (if (= 0 (get-fichas tablero p0 4)) 1 0)) 0.3)
     (* (- (if (= 0 (get-fichas tablero p1 2)) 1 0) (if (= 0 (get-fichas tablero p0 3)) 1 0)) 0.5)
     (* (- (if (= 0 (get-fichas tablero p1 3)) 1 0) (if (= 0 (get-fichas tablero p0 2)) 1 0)) 0.5)
     (* (- (if (= 0 (get-fichas tablero p1 4)) 1 0) (if (= 0 (get-fichas tablero p0 1)) 1 0)) 0.3)
     (* (- (if (= 0 (get-fichas tablero p1 5)) 1 0) (if (= 0 (get-fichas tablero p0 0)) 1 0)) 0.3))))
  ...
  (let ((tablero (estado-tablero estado)) (p0 (estado-lado-sgte-jugador estado))
   ...
   ;;;;  
    ...
    ; (* (- (if (= 0 (get-fichas tablero p0 5)) 1 0) (if (= 0 (get-fichas tablero p1 0)) 1 0)) 1.3)))) 
     ...
     (* (- (if (= 0 (get-fichas tablero p1 0)) 1 0) (if (= 0 (get-fichas tablero p0 5)) 1 0)) 2)
     (* (- (if (= 0 (get-fichas tablero p1 1)) 1 0) (if (= 0 (get-fichas tablero p0 4)) 1 0)) 2)
     (* (- (if (= 0 (get-fichas tablero p1 2)) 1 0) (if (= 0 (get-fichas tablero p0 3)) 1 0)) 7)
     (* (- (if (= 0 (get-fichas tablero p1 3)) 1 0) (if (= 0 (get-fichas tablero p0 2)) 1 0)) 6)
     (* (- (if (= 0 (get-fichas tablero p1 4)) 1 0) (if (= 0 (get-fichas tablero p0 1)) 1 0)) 2)
     (* (- (if (= 0 (get-fichas tablero p1 5)) 1 0) (if (= 0 (get-fichas tablero p0 0)) 1 0)) 4))))
...
;(partida 0 2 (list *Severus* *mi-bueno*))
;(partida 0 2 (list *mi-bueno* *Severus*))


(partida 0 2 (list *Albus10* *Albus10*))
(partida 0 2 (list *Esther* *Albus10*))

;(partida 0 2 (list *Severus* *Albus*))
;(partida 0 2 (list *mi-bueno* *Sirius*))

(partida 0 2 (list *Esther* *Esther*))
(partida 0 2 (list *Prueba* *Esther*))

(partida 0 2 (list *Prueba* *Esther*))
(partida 0 2 (list *Esther* *Prueba*))


(partida 0 2 (list *Severus* *Sirius*))
(partida 0 2 (list *Sirius* *Severus*))
