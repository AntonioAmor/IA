...
(defun mi-f-ev-buena (estado)
  ...
  (+ (- (get-pts p0) (get-pts p1))
     ...
     ;consideramos que es malo acumular demasiadas fichas en esta posicion
     (*(- (get-fichas tablero p1 4) (get-fichas tablero p0 4))0.4))))
...
(defun mi-f-ev-Severus (estado)
  ...
  (+ (- (get-pts p0) (get-pts p1))
     ...
     ;las fichas en la posicion 4 del contrario menos las mias
     ;consideramos que es malo acumular demasiadas fichas en esta posicion
     (*(- (get-fichas tablero p1 4) (get-fichas tablero p0 4))4))))
...
(defun mi-f-ev-Sirius (estado)
  ...
  (+ (- (get-pts p0) (get-pts p1))
     ...
     ;las fichas en la posicion 5 del contrario menos las mias
     ;consideramos que es malo acumular demasiadas fichas en esta posicion
     (*(- (get-fichas tablero p1 5) (get-fichas tablero p0 5))1)
     ;las fichas en la posicion 4 del contrario menos las mias
     ;consideramos que es malo acumular demasiadas fichas en esta posicion
     (*(- (get-fichas tablero p1 4) (get-fichas tablero p0 4))1))))
...
;(partida 0 2 (list *Severus* *Prueba*))
(partida 0 2 (list *su-jugador-a-b* *Albus*))
